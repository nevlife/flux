#!/usr/bin/env python3
"""Build an Image in a local buffer and publish it, one copy.

ros2 run flux_example_publish image_pub.py
"""
...
class ImagePublishPublisher(Node):
    ...
    def __init__(self):
        super().__init__("flux_publish_image_pub")
    ...
    def tick(self):
        ...
        self.report(self.publisher.publish(self.buf[: b.size]))
